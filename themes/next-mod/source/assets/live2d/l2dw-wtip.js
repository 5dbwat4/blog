...
! function () {
  ...
  class s {
    ...
    async loadModelList() {
      const e = await fetch("/assets/live2d/model_list.json");
      this.modelList = await e.json()
    }
    async loadModel(t, s, n) {
      if (localStorage.setItem("modelId", t), localStorage.setItem("modelTexturesId", s), 
      o(n, 4e3, 10), this.useCDN) {
    ...
    async loadRandModel() {
      ...
      if (this.useCDN) {
        ...
        loadlive2d("live2d", s), o("我的新衣服好看嘛？", 4e3, 10)
